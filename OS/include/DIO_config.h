...
#define PORTA_DIR_9        	  OUTPUT_PUSH_PULL_10MHZ
#define PORTA_DIR_10          OUTPUT_PUSH_PULL_10MHZ
...
#define PORTB_DIR_6         INPUT_PULL_UP_DOWN
#define PORTB_DIR_7         INPUT_PULL_UP_DOWN
#define PORTB_DIR_8         INPUT_PULL_UP_DOWN
...
#define PORTB_DIR_15         INPUT_PULL_UP_DOWN
